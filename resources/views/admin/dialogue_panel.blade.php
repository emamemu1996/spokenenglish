...
@endif
  ...
  <div class="form-group">
     ...
     <input type="text" class="form-control" id="dialoguename" name="dialoguename" value="" placeholder="dialogue name"> 
      ...
      <input type="hidden" class="form-control" id="type" name="type" value="dialogue" placeholder="dialogue name"> 
  ...
  <div class="form-group">
     ...
     <input type="text" class="form-control" id="characterone" name="characterone" value="" placeholder="Character One"> 
  ...
  <div class="form-group">
      <label for="title2">Character 2</label>
     <input type="text" class="form-control" id="charactertwo" name="charactertwo" value="" placeholder="Character Two"> 
