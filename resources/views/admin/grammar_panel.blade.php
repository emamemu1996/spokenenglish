...
@endif
  ...
  <div class="form-group">
     ...
     <input type="text" class="form-control" id="dialoguename" name="dialoguename" value="" placeholder="Title name"> 

      <input type="hidden" class="form-control" id="type" name="type" value="grammar" placeholder="dialogue name"> 

  </div>


  <div class="form-group">
      <label for="title2">Character 1</label>
     <textarea class="form-control" name="characterone" id="characterone" cols="4" rows="4">
...
<div class="modal modal-danger fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="form-group">
     ...
     <input type="hidden" class="form-control" id="priority" name="priority" value="" placeholder="priority"> 
